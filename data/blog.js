export const posts = [
  {
    id: 1,
    titulo: "Halloween: Consejos para una festividad segura para las mascotas",
    resumen: "Autoridades entregaron recomendaciones para evitar peligros durante Halloween, como dulces tóxicos y ruidos fuertes.",
    contenido: `
      En Chile, durante la celebración de Halloween, las autoridades recordaron que los dulces pueden ser tóxicos para perros y gatos,
  ...
  {
    id: 2,
    titulo: "Ley Duque: un día libre por duelo animal",
    resumen: "En Chile se discute la 'Ley Duque', que busca otorgar un día libre con goce de sueldo tras la pérdida de una mascota.",
    contenido: `
      La llamada 'Ley Duque' reconoce la importancia emocional de las mascotas en la vida de las personas.
  ...
  {
    id: 3,
    titulo: "7 de cada 10 hogares en Chile conviven con un perro o gato",
    resumen: "Un estudio reveló que el 70% de las familias chilenas tiene al menos un perro o gato, un aumento frente al 51% en 2018.",
    contenido: `
  ...
  {
    id: 4,
    titulo: "Chile declara al pingüino de Humboldt en peligro de extinción",
    resumen: "El pingüino de Humboldt fue declarado oficialmente en peligro de extinción en Chile.",
    contenido: `
      El Ministerio de Medio Ambiente declaró al pingüino de Humboldt en peligro de extinción debido a la reducción de su hábitat,
  ...
  {
    id: 5,
    titulo: "Abren el primer centro de rescate y rehabilitación de huemules",
    resumen: "Se inauguró en Chile el primer centro exclusivo para rescatar y rehabilitar huemules.",
    contenido: `
  ...
  {
    id: 6,
    titulo: "Senderistas se encuentran con un puma en Torres del Paine",
    resumen: "Un grupo de senderistas vivió un encuentro cercano con un puma en Torres del Paine.",
    contenido: `
